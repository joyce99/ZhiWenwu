...
def generate_new_dictionary(emb1, emb2, dico_max_rank=10000):
    '''
    ...
    #print("refi_all_pairs:", all_pairs.shape, type(all_pairs), all_pairs)
    # max dico words rank
    if dico_max_rank > 0:
    ...
    #print("refi_all_pairs_post:", all_pairs.shape, type(all_pairs), all_pairs)
