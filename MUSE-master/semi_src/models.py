...
class Encoder(nn.Module):
    def __init__(self, params):
        ...
        self.emb_dim = params.emb_dim # 300
...
def build_model(params, with_dis):
    ...
    discriminator_D = Discriminator_D(params) if with_dis else None
    # discriminator_B = Discriminator(params) if with_dis else None
    ...
    return src_emb, tgt_emb, mapping_G, mapping_F, discriminator_A, discriminator_B, encoder_A, decoder_A, encoder_B, decoder_B,discriminator_D
