...
class Trainer(object):
    ...
    def get_dis_xy(self, volatile):
        ...
        return x, y,src_emb_ori,src_emb
    ...
    def dis_step(self, stats):
        ...
        # loss
        x, y ,src_emb_ori,src_emb= self.get_dis_xy(volatile=True)
    ...
    def mapping_step(self, stats):
        ...
        # loss
        x, y,src_emb_ori,src_emb = self.get_dis_xy(volatile=False)
        preds = self.discriminator(x)
        loss = F.binary_cross_entropy(preds, 1 - y)
        loss = self.params.dis_lambda * loss
        #print("loss",loss)
        #loss_distance = self.get_distance_losses(src_emb_ori,src_emb)
        #print(loss_distance,"distance")
    ...
    def load_training_dico(self, dico_train):
        ...
        # use one of the provided dictionary
            ...
            print(os.path.join(DIC_EVAL_PATH, filename))
