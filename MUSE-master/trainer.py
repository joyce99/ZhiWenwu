...
class Trainer(object):
    ...
    def get_dis_xy(self, volatile):
        ...
        #print(",src_ids,tgt_ids",src_ids,tgt_ids),从源语言目标语言中随机采样
        ...
        #print(",src_ids,tgt_ids",src_ids,tgt_ids)
        # get word embeddings
    ...
    def mapping_step(self, stats):
        ...
        # loss
        x, y = self.get_dis_xy(volatile=False)#64*1
        #print("x,y:",x,y)
        preds = self.discriminator(x)#64*1
       # print("preds:",preds)
