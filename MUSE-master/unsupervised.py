...
if params.adversarial:
    ...
    src_A = src_emb.weight.data
    print(src_A.shape)
    tgt_B = tgt_emb.weight.data
    print(tgt_B.shape)

    print( src_A.mean())
    trainer.expectation_A = src_A.mean()  # tensor(0.0073, device='cuda:0')
    print(tgt_B.mean())
    trainer.expectation_B = tgt_B.mean()  # tensor(-0.0077, device='cuda:0')
    print(src_A.std())
    trainer.std_A = src_A.std()  # tensor(0.3085, device='cuda:0')
    print(tgt_B.std())
    trainer.std_B = tgt_B.std()  # tensor(0.2887, device='cuda:0')
